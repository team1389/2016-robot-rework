...
public class DigitalOut implements BooleanSupplier {
	...
	/**
	 * converts {@code out} to a <BinaryOutput>
	 * @param out normally stream of booleans
	 */
	...
	/**
	 * 
	 * @param name  the key to correspond with this stream
	 * @return a <BooleanInfo> with arguments of {@code name} and this stream 
	 */
