...
{
	//DriveOut<Percent> drive; may not be necessary 
 ...
 */
	...
	/**
	 * This is used to display values on the smart dash board 
	 * Uses lambda expressions, see me or @amind for explanation
	 */
	@Override
