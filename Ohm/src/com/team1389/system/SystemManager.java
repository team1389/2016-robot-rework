...
/**
 * stores a list of {@link Subsystem} objects that can be updated periodically. ensures that Subsystems are initialized before update is called
 * 
 * @author amind
 *
 */
public class SystemManager {
	 ...
	 * if the manager has not yet been initialized, it {@link SystemManager#init()} will be called before updating
	 */
	public void update() {
		if (!hasInited) {
			init();
