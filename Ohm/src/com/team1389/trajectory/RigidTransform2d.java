...
import com.team1389.util.interpolable.Interpolable;
...
public class RigidTransform2d implements Interpolable<RigidTransform2d> {
	...
	/**
	 * Movement along an arc at constant curvature and velocity. We can use ideas from "differential calculus" to create new RigidTransform2d's from a Delta.
	 **/
