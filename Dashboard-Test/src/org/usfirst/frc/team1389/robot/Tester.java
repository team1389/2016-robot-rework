...
public class Tester {
	...
	public static void init() {
		...
		cont = new SmoothSetController(.07, 0, 5, 7, 7, 30, pos, speed, sim.getVoltageOutput());
		PercentOut voltage = sim.getVoltageOutput();
		dash.watch(new NumberInput("voltage", 0.0, voltage::set));
