...
public class DoubleToStringFixedWidth {
	...
	public static void main(String[] args) {
		System.out.println(get(-123.45636, 7));
		System.out.println(get(5674.1236, 7));
		System.out.println(get(-11456764.213466, 7));
		System.out.println(get(1243564365474357346243637352364373462364752343534646319.9757, 7));
	 ...
	 * @param length Greater than or equal to 7 if you want all cases represented. Can be less, but some cases might go over.<br> 
	 * A negative really small or really large number is 7 long.<br>
	 * A positive really small or really large number and a negative large number is 6 long.<br>
